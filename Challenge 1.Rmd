...
author: "Emanuela Beale & Maya Lu & James Lee"
date: "2/11/2021"
...
pseudo_dat <- read.csv("recidivism_data_pseudo_new.csv")
...
pdat <- model.matrix(~ ., data=pseudo_dat) # Convert all categorical variable to dummies.


pyhat <- predict(final_model, newx = pdat, type = "response")[,1]
